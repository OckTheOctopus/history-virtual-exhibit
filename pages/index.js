...
function Postcontact() {
  return (
    <>
      ...
      <p className='description'>This is a VoC Duit. This was one of the coins minted by the VoC for its use in its trading posts (later restricted to just Indonesia). 20 Duits would make one Guilder. While the coin doesn&#39t tell us much, it symbolises the strength of the VoC. It would be unimaginable to us today if a company went to war with a sovereign state, yet the VoC - being a company in which you could trade on the Dutch exchange - essentially acted like a country and had powers that would be unthinkable to give to a company today. The VoC not only had a total monopoly granted to them on the spice trade; but they could wage wars, field and pay for their own armies, put their own currency into circulation, and execute their prisoners condemned under their own judicial system. It was also this immense power that led to corruption and bankruptcy, which would lead to the eventual collapse of the company and Indonesia being ruled outright by the Dutch State. The source is quite simple, and while it doesn&#39t offer much as to how the company was run or what was purchased, it stills tells us much about the sheer strength and power of a single company, and the powers entrusted to it by the state.</p>
