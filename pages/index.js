...
function Precontact() {
  return (
    <>
        ...
        <Image src='/../public/images/precontact1.jpg' alt='' height='300px' width='600px'></Image>
        <p className='description'>This is the Pentaran Temple. It is one of the largest Hindu temples on the island of Java. It was built during the time of the Kediri Kingdom, and was an important government building during the time of the Majapahit Kingdom.<br/>Temples are built not only for worship. Temples are a way to display the strength of a ruler - especially if the temples are large. Hinduism was a huge part of Indonesia&aposs history, with their proximity to India and their historically strong trading relations being the main factors for the spread of the religion to the islands. The fact that the temple was built and is still standing indicates that the Kediri Kingdom had sufficient power and resources to afford to build it, the inhabitants of the area valued it deeply, and that the area was stable enough to have it stay up. It also indicates that the rulers and inhabitants alike of the island cared very much about religion - even in times of crisis and war, the temple was left intact and was preserved to this day.<br/>This is, overall, a reliable source. The temple offers a glimpse into the island&aposs past and it does not pick a side in conflicts. It is quite useful in terms of the information it provides to us, but the temple alone cannot tell us everything about a kingdom, and we must cross-reference it with other sources to ensure the accuracy of any analysis of the island&aposs history.</p>
...
function Initialcontact() {
  return (
    <>
      ...
      <Image src='/../public/images/fleet.png' alt='' height='300px' width='600px'></Image>
...
function Postcontact() {
  return (
    <>
      ...
      <Image src='/../public/images/map.jpg' alt='' height='300px' width='600px'></Image>
      ...
      <h2>The VoC Duit</h2>
      <Image src='/../public/images/coin.webp' alt='' height='300px' width='600px'></Image>
      <p className='description'>This is a VoC Duit. This was one of the coins minted by the VoC for its use in its trading posts (later restricted to just Indonesia). 20 Duits would make one Guilder. While the coin doesn&apost tell us much, it symbolises the strength of the VoC. It would be unimaginable to us today if a company went to war with a sovereign state, yet the VoC - being a company in which you could trade on the Dutch exchange - essentially acted like a country and had powers that would be unthinkable to give to a company today. The VoC not only had a total monopoly granted to them on the spice trade; but they could wage wars, field and pay for their own armies, put their own currency into circulation, and execute their prisoners condemned under their own judicial system. It was also this immense power that led to corruption and bankruptcy, which would lead to the eventual collapse of the company and Indonesia being ruled outright by the Dutch State. The source is quite simple, and while it doesn&apost offer much as to how the company was run or what was purchased, it stills tells us much about the sheer strength and power of a single company, and the powers entrusted to it by the state.</p>
